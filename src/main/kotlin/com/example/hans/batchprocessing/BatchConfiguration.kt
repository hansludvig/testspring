...
class BatchConfiguration {
    ...
    fun reader(): FlatFileItemReader<Person> {
        val flatfile = FlatFileItemReaderBuilder<Person>()
    ...
    @Bean
    fun importUserJob(jobRepository: JobRepository, listener: JobCompletionNotificationListener, step1: Step): Job {
    ...
    @Bean
    fun step1(jobRepository: JobRepository, transactionManager: PlatformTransactionManager, writer: JdbcBatchItemWriter<Person>): Step {
